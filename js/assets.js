	...
	load(startGame) {
		...
		spriteSizes.forEach((entity, index) => {
			...
			img.onload = () => {
				...
				this[name].onload = () => this.countDown(startGame);
			}
		})
	}
	countDown(){
		this.remainingGraphicsToLoad--;
		if(this.remainingGraphicsToLoad === 0) this.startGame();
